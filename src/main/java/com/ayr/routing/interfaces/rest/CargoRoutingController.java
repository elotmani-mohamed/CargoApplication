package com.ayr.routing.interfaces.rest;
...
import com.ayr.routing.application.internal.queryservices.CargoRoutingQueryService;
import com.ayr.routing.domain.model.aggregates.Voyage;
import com.ayr.routing.domain.model.entities.CarrierMovement;
import com.ayr.shareddomain.model.TransitEdge;
import com.ayr.shareddomain.model.TransitPath;
...
public class CargoRoutingController {
    ...
    public TransitPath findOptimalRoute(
    	...
    	if(true) {
    		throw new RuntimeException("Just for Testingggggggggggggggggggggggggggg");
    	}
